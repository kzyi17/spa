...
<DIV class=mainBody> <DIV id=Left>
  ...
  <DIV id=Right>
    <DIV class="Item hr">
      <DIV class=current>文章访问明细：</DIV> 【<?php echo ($info['title']); ?>】
    </DIV>
    <table width="99.5%">
    	<colgroup>
  			<col />
    ...
    <table width="620" border="0" cellpadding="0" cellspacing="0" class="tab">
    	<colgroup>
  			<col width="50px"/>
			<col/>
			<col/>
      ...
      <tbody>
        <?php if(is_array($logList)): $i = 0; $__LIST__ = $logList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="">
            <td align="center"></td>
            <td align="center"><?php echo ($vo['client_ip']); ?></td>
