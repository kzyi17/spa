...
<DIV class=mainBody> <DIV id=Left>
  ...
  <DIV id=Right>
		...
		<tbody>
			<tr>
				<td>
					...
					<a href="<?php echo U('Share/goodsAdd');?>" class="btn">添加积分商品</a>
				</td>
				<td align="right">
    			</td>
			</tr>
    ...
    <table width="99.5%" border="0" cellpadding="0" cellspacing="0" class="tab">
      ...
      <tbody>
        <?php if(is_array($goodsList)): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($vo['sharegoods_id']); ?>">
            <td align="center"><input name="del_id[]" type="checkbox" value="<?php echo ($vo['sharegoods_id']); ?>" /></td>
            <td><?php echo ($vo['goods_name']); ?></td>
            <td><?php echo ($vo['merchant_name']); ?></td>
            <td align="center"><?php echo ($vo['exchange_point']); ?></td>
            <td align="center"><?php echo ($vo['stock']); ?></td>
            <td align="center">
				<a href='<?php echo U("Share/goodsEdit","id=".$vo['sharegoods_id']);?>'>[编辑]</a> 
				<a href="javascript:void(0)" onclick='delModel({link:"<?php echo U("Share/goodsDel","id=".$vo["sharegoods_id"]) ?>"})'>[删除]</a>
			</td>
