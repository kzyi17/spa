  ...
  <DIV id=Right>
    ...
    <TABLE class=tab border=0 cellSpacing=0 cellPadding=0 width="99%">
      ...
      <thead>
        <tr >
          <td width="8%">文章总数</td>
          <td width="8%">访问总数（注册会员）</td>
          <td width="8%">访问总数（游客）</td>
          <td width="8%">今日：<?php echo date('Y-m-d');?></td>
        </tr>
      </thead>
       <tr align="center">
          <td > <span style="color:red;"><?php echo ($articleCount); ?></span></td>
          <td><span style="color:red;"><?php echo ($hits_member); ?></span></td>
           <td><span style="color:red;"><?php echo ($hits_visitor); ?></span></td>
           <td><span style="color:red;"><a href="<?php echo U('share/tongji');?>">查看明细</a></span></td>
        </tr>
        </TBODY>
    </TABLE>
