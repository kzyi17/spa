...
<DIV class=mainBody> <DIV id=Left>
  ...
  <DIV id=Right>
    ...
    <div class="content_box">
    	<div class="content_box">
        <form action="/mlbspa/manage/Merchant/spaSave" name="spaForm" method="post">
        	<input type="hidden" name="spa_id" value="<?php echo ($spainfo['spa_id']); ?>" />
        	...
        	<div class="content form_content">
                ...
                <div id="table_box_1">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tab form_table">
                        ...
                        <tr>
                            <td>项目名称：</td>
                            <td>
                                <input class="normal" name="spa_name" type="text" pattern="required" value="<?php echo ($spainfo['spa_name']); ?>" alt="项目名称不能为空" /><label>*</label>
                            </td>
                        </tr>
                        <tr>
                            <td>项目简介：</td>
                            <td>
                                <textarea name="intro" style="width:400px;height:100px;"><?php echo ($spainfo['intro']); ?></textarea>
                                <label></label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select class="auto" name="merchant_id">
                                    ...
                                    <?php if(is_array($merchantList)): $i = 0; $__LIST__ = $merchantList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$merchant): $mod = ($i % 2 );++$i;?><option value="<?php echo ($merchant["merchant_id"]); ?>" <?php echo ($spainfo['merchant_id']==$merchant['merchant_id'] ? 'selected="selected"':''); ?>><?php echo ($merchant["merchant_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select class="auto" name="cate_id">
                                    <option value="0">请选择</option>
                                    <?php if(is_array($cateList)): $i = 0; $__LIST__ = $cateList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cate["cate_id"]); ?>" <?php echo ($spainfo['cate_id']==$cate['cate_id'] ? 'selected="selected"':''); ?>><?php echo ($cate["cate_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td>预约类型：</td>
                            <td>
                                <label class='attr'><input type="radio" name="order_type" value="1" <?php echo ($spainfo['order_type']==1 ? 'checked':''); ?>> 预约到店</label>
                                <label class='attr'><input type="radio" name="order_type" value="2" <?php echo ($spainfo['order_type']==2 ? 'checked':''); ?>> 预约上门</label>
                            </td>
                        </tr>
                        <tr>
                            <td>市场价格：</td>
                            <td>
                                <input class="tiny small" name="market_price" type="text" pattern="float" value="<?php echo ($spainfo['market_price']); ?>" />
                            	<label></label>
                            </td>
                        </tr>
                        <tr>
                            <td>本店售价：</td>
                            <td>
                                <input class="tiny small" name="sale_price" type="text" pattern="float" value="<?php echo ($spainfo['sale_price']); ?>" />
                            	<label></label>
                            </td>
                        </tr>
                    </table>
                ...
                <div id="table_box_2" style="display:none">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tab form_table">
                        ...
                        <tr>
                            <td>服务说明：</td>
                            <td><textarea id="introduce" name="introduce" style="width:680px;height:200px;"><?php echo ($spainfo['introduce']); ?></textarea></td>
                        </tr>
                        <tr>
                            <td>购买须知：</td>
                            <td><textarea id="buynotes" name="buynotes" style="width:680px;height:200px;"><?php echo ($spainfo['buynotes']); ?></textarea></td>
                        </tr>
                    </table>
                </div>
				<!-- 相片选项 -->
...
$(function()
{
	...
	//商品默认图片
	<?php if(isset($spainfo['spa_cover']) AND $spainfo['spa_cover']): ?>$('#thumbnails img[alt="<?php echo $spainfo['spa_cover'];?>"]').addClass('current');<?php endif; ?>
