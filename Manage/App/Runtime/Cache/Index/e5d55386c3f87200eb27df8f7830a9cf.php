...
<DIV class=mainBody> <DIV id=Left>
  ...
  <DIV id=Right>
    ...
    <table width="99.5%" border="0" cellpadding="0" cellspacing="0" class="tab">
      ...
      <tbody>
        <?php if(is_array($articleList)): $i = 0; $__LIST__ = $articleList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="">
            ...
            <td align="center"><?php echo ($vo['logCount']); ?></td>
            <td align="center"><?php echo ($vo['logCount_visitor']); ?></td>
            <td><a href="<?php echo U('share/tongjiDetail','id='.$vo['article_id']);?>">游客IP明细</a></td>
