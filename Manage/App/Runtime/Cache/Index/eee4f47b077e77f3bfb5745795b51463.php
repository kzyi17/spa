...
<DIV class=mainBody> <DIV id=Left>
  ...
  <DIV id=Right>
		...
		<tbody>
			<tr>
				<td>
					...
					<a href="<?php echo U('Share/articleAdd');?>" class="btn">添加文章</a>
				</td>
				<td align="right">
    			</td>
			</tr>
    ...
    <table width="99.5%" border="0" cellpadding="0" cellspacing="0" class="tab">
      ...
      <tbody>
        <?php if(is_array($articleList)): $i = 0; $__LIST__ = $articleList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($vo['product_id']); ?>">
            ...
            <td align="center"><?php echo ($vo['sharepoint']); ?></td>
            <td align="center">
			...
			<?php else: ?>
				<a href='<?php echo U("Share/articleEdit","id=".$vo['article_id']);?>'>[编辑]</a> 
				<a href="javascript:void(0)" onclick='delModel({link:"<?php echo U("Share/articleDel","id=".$vo["article_id"]) ?>"})'>[删除]</a><?php endif; ?>
			</td>
