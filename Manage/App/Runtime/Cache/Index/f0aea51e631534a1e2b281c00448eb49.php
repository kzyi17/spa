...
<DIV class=mainBody> <DIV id=Left>
  ...
  <DIV id=Right>
    ...
    <div class="content_box">
    	<div class="content_box">
        <form action="/mlbspa/manage/Share/goodsSave" name="spaForm" method="post">
        	<input type="hidden" name="sharegoods_id" value="<?php echo ($goods['sharegoods_id']); ?>" />
        	...
        	<div class="content form_content">
                ...
                <div id="table_box_1">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tab form_table">
                        ...
                        <tr>
                            <td>商品名称：</td>
                            <td>
                                <input class="normal" name="goods_name" type="text" pattern="required" value="<?php echo ($goods['goods_name']); ?>" alt="商品名称不能为空" /><label>*</label>
                            </td>
                        </tr>
                        <tr>
                            <td>商品简介：</td>
                            <td>
                                <textarea name="intro" style="width:400px;height:100px;"><?php echo ($goods['intro']); ?></textarea>
                                <label></label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select class="auto" name="merchant_id">
                                    ...
                                    <?php if(is_array($merchantList)): $i = 0; $__LIST__ = $merchantList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$merchant): $mod = ($i % 2 );++$i;?><option value="<?php echo ($merchant["merchant_id"]); ?>" <?php echo ($goods['merchant_id']==$merchant['merchant_id'] ? 'selected="selected"':''); ?>><?php echo ($merchant["merchant_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td>多少积分可兑换：</td>
                            <td>
                                <input class="tiny small" name="exchange_point" type="text" pattern="float" value="<?php echo ($goods['exchange_point']); ?>" />
                            	<label></label>
                            </td>
                        </tr>
                        <tr>
                            <td>库存：</td>
                            <td>
                                <input class="tiny small" name="stock" type="text" pattern="float" value="<?php echo ($goods['stock']); ?>" />
                            	<label></label>
                            </td>
                        </tr>
                    </table>
                ...
                <div id="table_box_2" style="display:none">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tab form_table">
                        ...
                        <tr>
                            <td>商品介绍：</td>
                            <td><textarea id="introduce" name="introduce" style="width:680px;height:400px;"><?php echo ($goods['introduce']); ?></textarea></td>
                        </tr>
                    </table>
                </div>
				<!-- 相片选项 -->
...
$(function()
{
	...
	//商品相册图片回填
	<?php if(($goods['_imglist'])): ?>var goodsPhoto = <?php echo json_encode($goods['_imglist']);?>;
	...
	//商品默认图片
	<?php if(isset($goods['cover']) AND $goods['cover']): ?>$('#thumbnails img[alt="<?php echo $goods['cover'];?>"]').addClass('current');<?php endif; ?>
