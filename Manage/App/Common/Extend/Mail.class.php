...
class Mail
{
	...
	public function __construct($site_config = null)
	{
		if($site_config == null)
		{
			$siteConfigObj = include(realpath('App/Common/Conf/site.php'));
			$site_config['email_type'] = $siteConfigObj['email_type'];
			$site_config['mail_address'] = $siteConfigObj['mail_address'];
			$site_config['smtp'] = $siteConfigObj['smtp'];
			$site_config['smtp_user'] = $siteConfigObj['smtp_user'];
			$site_config['smtp_pwd'] = $siteConfigObj['smtp_pwd'];
			$site_config['smtp_port'] = $siteConfigObj['smtp_port'];
