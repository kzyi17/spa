...
function SelectZone()
{
  ...
  {
	  $.getJSON(act,filters,this.loadOptionsResponse);
   ...
   */
  this.addItem = function(all, act, goodsId, is_double)
  {
    ...
    if (selOpt.length > 0)
    {
      ...
      $.getJSON(act,{'goods_id':goodsId,'is_double':is_double,'add_ids':opt},this.addRemoveItemResponse);
    }
  }
   ...
   * @param   string     act
   */
  this.dropItem = function(all, act, goodsId)
  {
    ...
    if (arr.length > 0)
    {
      ...
      $.getJSON(act,{'goods_id':goodsId,'drop_ids':arr},this.addRemoveItemResponse);
